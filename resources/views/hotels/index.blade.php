       ...
       <div class="row">
        ...
        <div class="col-12">
          <div style=" padding: 10px; " class="card shadow">
            ...
            <a href="{{route('addhotel')}}"><button class="btn" style="    height: 30px;
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              @if (Auth::user()->role == 1)
                              <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete{{$hotel->id}}" href="#">Delete</a></li>
                              <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit{{$hotel->id}}" href="#">Edit</a></li>
                              @endif
                             </ul>
                          </div>
