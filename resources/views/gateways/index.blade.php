                        ...
                        <th scope="row">
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <a href="{{route('profile',$gateway->id)}}" class="mb-0 text-sm">{{$gateway->gateway}}</a>
                            </div>
                          </div>
                        </th>
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              @if (Auth::user()->role == 1)
                                <li><a class="dropdown-item del"  data-bs-toggle="modal" data-bs-target="#delete" href="#"><input type="hidden" class="id" value="{{$gateway->id}}" >Delete</a></li>
                                <li><a class="dropdown-item getid" data-bs-toggle="modal" data-bs-target="#edit" href="#"><input type="hidden" class="id" value="{{$gateway->id}}" ><input type="hidden" class="name" value="{{$gateway->gateway}}" >Edit</a></li>
                              @endif
                             </ul>
                          </div>
...
@include('gateways.delete')
@include('gateways.edit')
@include('gateways.add')
